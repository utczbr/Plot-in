...
MODELS_CONFIG = ModelsConfig(
    ...
    detection={
        ...
        'heatmap_macro': 'heatmap_macro_detect.onnx',
        'heatmap_colorbar': 'heatmap_colorbar_detect.onnx',
        'heatmap_lattice': 'heatmap_lettice_detect.onnx',
        'heatmap_text': 'heatmap_text_detect.onnx',
        'pie': 'Pie_pose.onnx',
    ...
    detection_output_type={
        ...
        'scatter': 'bbox',
        'histogram': 'yolo_nms',
        'heatmap_macro': 'yolo_nms',
        'heatmap_colorbar': 'yolo_nms',
        'heatmap_lattice': 'yolo_nms',
        'heatmap_text': 'yolo_nms',
        'pie': 'pose',
        'area': 'bbox',
        'doclayout': 'bbox',
    },
